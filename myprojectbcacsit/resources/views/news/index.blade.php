    ...
    <table id="mytable" class="display">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{route('news.edit',$new->id)}}" class="bg-blue-600 text-white px-3 py-1 rounded-lg mx-1">Edit</a>
                    <a onclick="showDelete('{{$new->id}}')" class="bg-red-600 text-white px-3 py-1 rounded-lg mx-1">Delete</a>
                </td>
            </tr>
            @endforeach
        </tbody>
